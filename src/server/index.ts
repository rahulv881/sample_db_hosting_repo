...
import ElasticsearchUtil from './utils/elastic/client';
import RabbitMQUtil from './utils/rabbitmq/client';
...
export class Server {
    ...
    public static init = async () => {
        ...
        {
            /**
             * Functor to close elastic search connection
             */
            functor: ElasticsearchUtil.closeElasticsearchConnection
        },
        {
            /**
             * Functor to close rabbit mq connection
             */
            functor: RabbitMQUtil.closeRabbitMQConnection
        },
        ]);
